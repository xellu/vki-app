...
subject_labels = {
    ...
    "Стандартизация, сертификация и техническое документоведение": "СТД",
    ...
    "Аппаратно-программные интерфейсы микроконтроллерных систем": "АПИ",
    ...
    "Производственная практика по профилю специальности ПМ.11 Разработка, администрирование и защита баз данных": "БДЗ",
    ...
    "Учебная практика ПМ.04 Сопровождение и обслуживание программного обеспечения компьютерных систем": "СОП",
    ...
    "Учебная практика ПМ.03 Техническое обслуживание и ремонт компьютерных систем и комплексов": "ТОР",
    ...
    "Учебная практика ПМ.04 Выполнение работ по профессии рабочего": "ОЭМ",
