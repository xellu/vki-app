...
from nautica import Logger as logger, Service
from plugins.XelDB import XelDB

from src.lib.Language import Messages
from src.lib.models.Order import Order
from src.lib.models.Grade import GradeEntry, SubjectGrades, Year
...
class NsuAPI(Service):
    ...
    class NsuAPIClient:
        ...
        async def _load_years(self, client: httpx.AsyncClient) -> dict[str, Year]:
            ...
            cached = self.YearsDB.getByKey("global")
            if cached:
                self._years = {
            ...
            if cached:
                self.YearsDB.setByKey("global", "years", years_data)
            else:
                self.YearsDB.create(key="global", years=years_data)
        ...
        def invalidate_years_cache(self):
            ...
            self._years = None
            self.YearsDB.removeByKey("global")
