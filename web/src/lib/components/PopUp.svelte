...
{#if open && loaded}
    <div class="w-screen h-screen p-3 fixed top-0 left-0 flex items-center justify-center bg-linear-to-tl from-surface-100-900/50 to-surface-50-950/50 backdrop-blur-sm z-50"
        onclick={(e) => {
            // console.log(e)
        ...
        <!-- form -->
        <div class="card bg-surface-50-950 w-full z-50 {maxW ? maxW : ''}" transition:scale={{duration: 250}}>
